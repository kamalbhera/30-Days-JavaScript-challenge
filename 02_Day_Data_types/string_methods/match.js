...
let stng = 'I love JavaScript. If you do not love JavaScript what else can you love.'
console.log(stng.match('love')) //
/*
output
...
*/
let pattern = /love/gi
console.log(stng.match(pattern)) // ["love", "love", "love"]
